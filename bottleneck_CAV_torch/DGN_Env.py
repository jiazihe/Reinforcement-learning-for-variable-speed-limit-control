...
from flow.controllers import RLController, IDMController, ContinuousRouter, GippsController
...
from flow.controllers.rlcontroller import RLController, RLandIDMController, RLController2
...
def para_produce_rl(HORIZON=3000, NUM_AUTOMATED=4, No_RL=False):
    ...
    # if No_RL:                                       # all the vehicles are controlled by IDM controller
    #     vehicles.add(
    #         veh_id="human",
    ...
    # else:                                   # multi-agent environment, part of vehicles controlled by rl
